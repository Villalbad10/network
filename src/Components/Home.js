...

                {
                    ...
                    data.map(user => (
                        <Card key={user.id}>
                            ...
                            <span style={{ 'fontWeight': '600', 'width': '92%', 'margin': '0 auto', 'display': 'flex', 'flexDirection': 'column', 'marginTop': '10px' }} >{user.name}<p style={{ 'fontWeight': '400', 'fontSize': '10px', 'color': '#B8B8B8' }}>Lorem ipsum dolor sit amet, consectetur adipiscing
